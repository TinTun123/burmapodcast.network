<template>
    <div class="w-full laptop:px-2 z-[9999] relative" @click="reset_icon">
                ...
                <div class="flex laptop:w-[60%] gap-x-2">
                    <div  @click="openFile" 
                        ...
                        laptop:aspect-square">
                          ...
                          <div  id="div" class="grid tablet:hidden grid-cols-3 flex-none w-[50%] gap-1 relative">
        ...
        <div class="flex items-center gap-x-4">
            ...
            <div  id="div" class="hidden tablet:flex gap-x-4 tablet:flex-wrap grid-cols-3 flex-none w-[50%] gap-1 relative">
        ...
        <div class="overflow-x-visible px-1">
            <label class="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" v-model="episodestate" class="sr-only peer">
              ...
              <span class="ml-3 text-x-sm font-semibold text-[#72B3FD] transition ">{{ episodestate ? 'Pubish' : 'Pending' }}</span>
            </label>
...
function addEpisode () {
    ...
    if (title.value && desc.value && host.value) {
    ...
    formData.append('state', episodestate.value);
        ...
        console.log(title.value, desc.value, host.value, duration.value);
...
onMounted(() => {
    ...
    if (Object.keys(props.editEpi).length) {
        ...
        coverImg.value = props.editEpi.img_url;
        ...
        spotify.value = props.editEpi.spotify;
        pod_beam.value = props.editEpi.pod_beam;
        sound_cloud.value = props.editEpi.sound_cloud;
        google_podcast.value = props.editEpi.google_podcast;
        apple_podcast.value = props.editEpi.apple_podcast;
        episodestate.value = props.editEpi.state ? true : false;

        console.log('currentEpi', props.editEpi);
