<template>
    <div class="relative">
        ...
        <div class="flex flex-col tablet:flex-row items items-center gap-x-2">
        ...
        <div class="flex flex-nowrap gap-x-4 py-4 h-full overflow-x-scroll overflow-y-visible scroll-container">
