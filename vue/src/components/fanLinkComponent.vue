<template>
    <div class="tablet:fixed tablet:top-[30%] tablet:left-0 tablet:right-0">
        <div class="flex justify-center items-center py-4 z-[9999] relative">
            <div class="flex laptop:flex-row flex-col gap-4">
                ...
                <div class="grid grid-cols-1 items-stretch tablet:grid-cols-2 gap-4 w-full">
                    ...
                    <div @click.stop="dropSpotify = !dropSpotify; dropApple = false" class="p-4 group flex gap-x-12 laptop:cursor-pointer bg-[#1D1D1D] h-[64px] justify-between items-center rounded-[4px] shadow-card-shadow relative">
                        ...
                        <transition name="slide-down">
                            <div v-if="dropSpotify"  class="bg-[#1D1D1D] absolute w-full top-[64px] max-h-[234px] overflow-y-scroll z-[9999] left-0 overflow-hidden rounded-b-[15px]">
